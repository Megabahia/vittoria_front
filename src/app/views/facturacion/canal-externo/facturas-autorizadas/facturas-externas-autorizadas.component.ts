...
@Component({
  ...
  templateUrl: './facturas-externas-autorizadas.component.html',
  styleUrls: ['./facturas-externas-autorizadas.component.css'],
  providers: [DatePipe]
})
export class FacturasExternasAutorizadasComponent implements OnInit {
  menu;
  page = 1;
  pageSize = 3;
  collectionSize;
