...
@Component({
  selector: 'app-ventas-vendedor-metodo-envio',
  templateUrl: './ventas-vendedor-metodo-envio.component.html',
  providers: [DatePipe]
})
export class VentasVendedorMetodoEnvioComponent implements OnInit, AfterViewInit {
  ...
  obtenerTransacciones(): void {
    this.pedidosService.obtenerListaPedidos({
      ...
      //this.listaMetodoPago = info.metodosEnvios;
