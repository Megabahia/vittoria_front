...
@Component({
  ...
  templateUrl: './reporte_contactos-listar.component.html',
  styleUrls: ['reporte_contactos-listar.component.css'],
  providers: [DatePipe]
})
export class ReporteContactosListarComponent implements OnInit, AfterViewInit {
