...
@Component({
  selector: 'app-pedido-contraentrega',
  templateUrl: './pedido-contraentrega.component.html',
  providers: [DatePipe]
})
export class PedidoContraentregaComponent implements OnInit, AfterViewInit {
  ...
  obtenerTransacciones(): void {
    this.pedidosService.obtenerListaPedidos({
      ...
      estado: ['Pendiente'],
      canal: ['contraentrega.megadescuento.com'],
