...
@Component({
  selector: 'app-pedido-todomegacentro',
  templateUrl: './pedido-todomegacentro.component.html',
  providers: [DatePipe]
})
export class PedidoTodomegacentroComponent implements OnInit, AfterViewInit {
