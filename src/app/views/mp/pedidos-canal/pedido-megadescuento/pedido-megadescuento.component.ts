...
@Component({
  selector: 'app-pedido-megadescuento',
  templateUrl: './pedido-megadescuento.component.html',
  providers: [DatePipe]
})
export class PedidoMegadescuentoComponent implements OnInit, AfterViewInit {
