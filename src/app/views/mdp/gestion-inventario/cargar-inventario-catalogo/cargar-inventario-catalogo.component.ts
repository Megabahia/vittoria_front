...
@Component({
  ...
  templateUrl: './cargar-inventario-catalogo.component.html',
})
export class CargarInventarioCatalogoComponent implements OnInit {
  menu;
  ...
  cargarInventarioCatalogo(): void {
    ...
    this.gestionInventarioService.cargarInventarioCatalogo(this.archivo).subscribe((info) => {
