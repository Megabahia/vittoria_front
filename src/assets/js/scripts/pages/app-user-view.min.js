$((function() { "use strict"; var a = $(".invoice-list-table"),
        ...
        s = "app-invoice-edit.html"; if ("laravel" === $("body").attr("data-framework") && (t = $("body").attr("data-asset-path"), e = t + "app/invoice/preview", n = t + "app/invoice/add", s = t + "app/invoice/edit"), $(".nextYear").text((new Date).getFullYear() + 1), a.length) a.DataTable({ ajax: t + "data/invoice-list.json", autoWidth: !1, columns: [{ data: "responsive_id" }, { data: "invoice_id" }, { data: "invoice_status" }, { data: "issued_date" }, { data: "client_name" }, { data: "total" }, { data: "balance" }, { data: "invoice_status" }, { data: "" }], columnDefs: [{ className: "control", responsivePriority: 2, targets: 0 }, { targets: 1, width: "46px", render: function(a, t, n, s) { var i = n.invoice_id; return '<a class="font-weight-bold" href="' + e + '"> #' + i + "</a>" } }, { targets: 2, width: "42px", render: function(a, t, e, n) { var s = e.invoice_status,
            ...
            [1, "desc"]
                    ...
                    t = $('<select id="UserRole" class="form-control ml-50 text-capitalize"><option value=""> Select Status </option></select>').appendTo(".invoice_status").on("change", (function() { var t = $.fn.dataTable.util.escapeRegex($(this).val());
                        a.search(t ? "^" + t + "$" : "", !0, !1).draw() }));
                a.data().unique().sort().each((function(a, e) { t.append('<option value="' + a + '" class="text-capitalize">' + a + "</option>") })) })) }, drawCallback: function() { $(document).find('[data-toggle="tooltip"]').tooltip() } }) }));