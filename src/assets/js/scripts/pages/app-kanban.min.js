$((function() { "use strict"; var a, t = !0,
        ...
        c = "../../../assets/"; if ("laravel" === $("body").attr("data-framework") && (c = $("body").attr("data-asset-path")), $.ajax({ type: "GET", dataType: "json", async: !1, url: c + "data/kanban.json", success: function(t) { a = t } }), l.toggle(), d.length && d.flatpickr({ monthSelectorType: "static", altInput: !0, altFormat: "j F, Y", dateFormat: "Y-m-d" }), i.length) {
        function m(a) { return a.id ? "<div class='badge " + $(a.element).data("color") + " badge-pill'> " + a.text + "</div>" : a.text }
        i.each((function() { var a = $(this);
            a.wrap("<div class='position-relative'></div>").select2({ placeholder: "Select Label", dropdownParent: a.parent(), templateResult: m, templateSelection: m, escapeMarkup: function(a) { return a } }) })) }

    function p() { return "<div class='dropdown'>" + feather.icons["more-vertical"].toSvg({ class: "dropdown-toggle cursor-pointer font-medium-3 mr-0", id: "board-dropdown", "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false" }) + "<div class='dropdown-menu dropdown-menu-right' aria-labelledby='board-dropdown'><a class='dropdown-item delete-board' href='javascript:void(0)'> " + feather.icons.trash.toSvg({ class: "font-medium-1 align-middle" }) + "<span class='align-middle ml-25'>Delete</span></a><a class='dropdown-item' href='javascript:void(0)'>" + feather.icons.edit.toSvg({ class: "font-medium-1 align-middle" }) + "<span class='align-middle ml-25'>Rename</span></a><a class='dropdown-item' href='javascript:void(0)'>" + feather.icons.archive.toSvg({ class: "font-medium-1 align-middle" }) + "<span class='align-middle ml-25'>Archive</span></a></div></div>" }

    function u() { return "<div class='dropdown item-dropdown px-1'>" + feather.icons["more-vertical"].toSvg({ class: "dropdown-toggle cursor-pointer mr-0 font-medium-1", id: "item-dropdown", " data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false" }) + "<div class='dropdown-menu dropdown-menu-right' aria-labelledby='item-dropdown'><a class='dropdown-item' href='javascript:void(0)'>Copy task link</a><a class='dropdown-item' href='javascript:void(0)'>Duplicate task</a><a class='dropdown-item delete-task' href='javascript:void(0)'>Delete</a></div></div>" }

    function b(a, t) { return "<div class='d-flex justify-content-between flex-wrap align-items-center mb-1'><div class='item-badges'> <div class='badge badge-pill badge-light-" + a + "'> " + t + "</div></div>" + u() + "</div>" }

    function v(a, t, e, n, d) { var i = t ? " pull-up" : "",
            o = void 0 !== n ? n.split(",") : ""; return void 0 !== a ? a.split(",").map((function(a, t, n) { var s = void 0 !== e && t !== n.length - 1 ? " mr-" + e : ""; return "<li class='avatar kanban-item-avatar " + i + " " + s + "'data-toggle='tooltip' data-placement='top'title='" + o[t] + "'><img src='" + c + "images/portrait/small/" + a + "' alt='Avatar' height='" + d + "'></li>" })).join(" ") : "" }

    function f(a, t, e, n) { return "<div class='d-flex justify-content-between align-items-center flex-wrap mt-1'><div> <span class='align-middle mr-50'>" + feather.icons.paperclip.toSvg({ class: "font-medium-1 align-middle mr-25" }) + "<span class='attachments align-middle'>" + a + "</span></span> <span class='align-middle'>" + feather.icons["message-square"].toSvg({ class: "font-medium-1 align-middle mr-25" }) + "<span>" + t + "</span></span></div><ul class='avatar-group mb-0'>" + v(e, !0, 0, n, 28) + "</ul></div>" }
