$((function() { "use strict"; var e = "../../../assets/",
        t = { type: "FeatureCollection", features: [{ type: "Feature", id: "01", properties: { name: "Alabama", density: 94.65 }, geometry: { type: "Polygon", coordinates: [
                        [
                            [-87.359296, 35.00118],
                            [-85.606675, 34.984749],
                            [-85.431413, 34.124869],
                    ...
                    ] } }, { type: "Feature", id: "28", properties: { name: "Mississippi", density: 63.5 }, geometry: { type: "Polygon", coordinates: [
                        [
                            [-88.471115, 34.995703],
                            [-88.202745, 34.995703],
                            [-88.098683, 34.891641],
                    ...
                    ] } }, { type: "Feature", id: "32", properties: { name: "Nevada", density: 24.8 }, geometry: { type: "Polygon", coordinates: [
                        [
                            [-117.027882, 42.000709],
                            [-114.04295, 41.995232],
                            [-114.048427, 37.000263],
                    ...
                    ] } }, { type: "Feature", id: "49", properties: { name: "Utah", density: 34.3 }, geometry: { type: "Polygon", coordinates: [
                        [
                            [-112.164359, 41.995232],
                            [-111.047063, 42.000709],
                    ...
                    ] } }] }; if ("laravel" === $("body").attr("data-framework") && (e = $("body").attr("data-asset-path")), $("#basic-map").length) { var o = L.map("basic-map").setView([42.35, -71.08], 10);
        L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(o) } if ($("#shape-map").length) { var r = L.map("shape-map").setView([51.5, -.09], 12);
        L.marker([51.5, -.09]).addTo(r), L.circle([51.508, -.11], { color: "red", fillColor: "#f03", fillOpacity: .5, radius: 500 }).addTo(r), L.polygon([
            [51.509, -.08],
            [51.503, -.06],
            [51.51, -.047]
        ]).addTo(r);
        L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(r) } if ($("#drag-map").length) { var a = L.map("drag-map").setView([48.817152, 2.455], 12);
        L.marker([48.817152, 2.455], { draggable: "true" }).addTo(a).bindPopup("<b>You're here!</b>").openPopup(), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(a) } if ($("#user-location").length) { var i = L.map("user-location").setView([42.35, -71.08], 10);
        i.locate({ setView: !0, maxZoom: 16 }), i.on("locationfound", (function(e) { var t = e.accuracy;
            L.marker(e.latlng).addTo(i).bindPopup("You are somewhere around " + t + " meters from this point").openPopup(), L.circle(e.latlng, t).addTo(i) })), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(i) } if ($("#custom-icons").length) { var n = L.map("custom-icons").setView([51.5, -.09], 10),
        ...
        L.marker([51.5, -.09], { icon: y }).addTo(n), L.marker([51.4, -.51], { icon: p }).addTo(n), L.marker([51.49, -.45], { icon: s }).addTo(n), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(n) } if ($("#geojson").length) { var d = L.map("geojson").setView([44.2669, -72.576], 3);
        L.geoJson(t).addTo(d), L.geoJson(t, { style: function(e) { return { fillColor: (t = e.properties.density, t > 1e3 ? "#800026" : t > 500 ? "#BD0026" : t > 200 ? "#E31A1C" : t > 100 ? "#FC4E2A" : t > 50 ? "#FD8D3C" : t > 20 ? "#FEB24C" : t > 10 ? "#FED976" : "#FFEDA0"), weight: 2, opacity: 1, color: "white", dashArray: "3", fillOpacity: .7 }; var t } }).addTo(d), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(d) } if ($("#layer-control").length) { var m = L.marker([39.61, -105.02]).bindPopup("This is Littleton, CO."),
